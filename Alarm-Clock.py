    ...
    while True:
        ...
        if now == set_alarm_timer:
            ...
            while play != 10:  # This will ring alarm for 10 seconds
                playsound("E:\\My Data Science full for job - Copy\\Project Practice for Placements\\Day-01\\Beginner-Python-Projects-main\\Alarm Clock\\sound.wav")
                play += 1
...
hourTime = Entry(clock, textvariable=hour, bg="powderblue", width=15).place(x=150, y=120)
minTime = Entry(clock, textvariable=min, bg="powderblue", width=15).place(x=190, y=120)
secTime = Entry(clock, textvariable=sec, bg="powderblue", width=15).place(x=240, y=120)

set_alarm = Button(clock, text="Set Alarm", fg="green", activebackground="grey", activeforeground="darkgreen", width=10, font=("Arial", 15, 'bold'), command=actual_time).place(x=200, y=150)
